import { VideoRecorderPlugin, VideoRecorderOptions, VideoRecorderPreviewFrame } from '@/types/videoRecorder';
...
export class VideoRecorder implements VideoRecorderPlugin {
